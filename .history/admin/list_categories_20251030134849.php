                                            ...
                                            <td class="p-4 border border-gray-300">
                                                <div class="flex justify-center space-x-2">
                                                    ...
                                                    <a href="?delete=<?php echo $category['id']; ?>" 
                                                       class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-700 transition-colors flex items-center <?php echo $category['post_count'] > 0 ? 'opacity-50 cursor-not-allowed' : ''; ?>"
                                                       onclick="return confirm('<?php echo $category['post_count'] > 0 ? 'This category has ' . $category['post_count'] . ' post(s). ' : ''; ?>Are you sure you want to delete the category \"<?php echo addslashes($category['name']); ?>\"?')"
