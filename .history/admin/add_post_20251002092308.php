            ...
            <div class="form-container">
                ...
                <form id="postForm" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="postContent" name="postContent" class="content-textarea" placeholder="Write your full post content here..."></textarea>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.validator.addMethod("ckeditorRequired", function(value, element) {
                var editorContent = CKEDITOR.instances[element.id].getData();
                return editorContent.replace(/<[^>]*>/gi, '').trim().length > 0;
            ...
            $("#postForm").validate({
                ...
                messages: {
                    ...
                    postContent: {
                        ckeditorRequired: "This field is required."
                    },
                    postExcerpt: {
                ...
                errorPlacement: function(error, element) {
                    if (element.attr("name") == "postContent") {
                        error.insertAfter($('.cke'));
                    } else {
