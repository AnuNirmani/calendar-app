                                ...
                                <?php foreach ($posts as $post): ?>
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <a href="edit_post.php?id=<?= $post['id'] ?>" class="edit-btn" data-tooltip="Edit Post">Edit</a>
                                            <a href="?delete=<?= $post['id'] ?>" class="delete-btn" data-tooltip="Delete Post" onclick="return confirm('Are you sure you want to delete this post?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#postsTable').DataTable({
                ...
                columnDefs: [
                    { orderable: false, targets: [3, 6] } // Disable sorting for Image and Actions columns
                ],
                language: {
                    search: "Search posts:",
                    search