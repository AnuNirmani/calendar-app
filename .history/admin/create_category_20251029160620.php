                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <form method="POST" action="" class="space-y-6">
                        ...
                        <div class="flex space-x-4 pt-4">
                            ...
                            <a 
                                href="list_categories.php" 
                                class="flex-1 bg-gray-600 text-white py-3 px-4 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors text-center"
                            >
                                View All Categories
                            </a>
                        </div>
