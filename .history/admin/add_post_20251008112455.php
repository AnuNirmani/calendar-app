...
<body>
    ...
    <div class="main-container">
        <div class="sidebar">
            ...
            <button class="active" onclick="window.location.href='add_post.php'" aria-label="Create Post">
            ...
            <button onclick="window.location.href='list_posts.php'" aria-label="List Posts">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M3 7h18M3 12h18M3 17h18"/>
                </svg>
                <span>List Posts</span>
            </button>
            <button onclick="window.location.href='post_views.php'" aria-label="Post Views">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <script>
        ...
        function toggleSidebarCollapse() {
            ...
            if (window.innerWidth > 768) {
                ...
                collapseIcon.setAttribute('d', sidebar.classList.contains('collapsed') ? 'M9 6l6 6-6 6' : 'M15 18l-6-6 6-6');
            }
        }
