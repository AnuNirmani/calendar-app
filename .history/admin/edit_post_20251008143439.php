        ...
        <div class="content-wrapper">
            <div class="header-section">
                ...
                <div class="page-title">
                    <h1>Edit Post</h1>
                    <p>Update the details of the blog post</p>
                </div>
            </div>
                ...
                <div class="form-container">
                    ...
                    <form id="postForm" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="postTitle" name="postTitle" value="<?= htmlspecialchars($post['title']) ?>" placeholder="Enter an engaging title...">
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="postExcerpt" name="postExcerpt" placeholder="Write a compelling summary..."><?= htmlspecialchars($post['excerpt']) ?></textarea>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="publishDate" name="publishDate" value="<?= date('Y-m-d\TH:i', strtotime($post['publish_date'])) ?>">
                            </div>
                        </div>
                        <div class="form-group full-width">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn-secondary" onclick="goBack()">Back to Posts</button>
                        </div>
                    </form>
                </div>
            </div>
