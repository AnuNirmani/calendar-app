                                    ...
                                    <tr>
                                        ...
                                        <td class="email-cell">
                                            <?php if (!empty($row['email'])): ?>
                                                <a href="mailto:<?php echo htmlspecialchars($row['email']); ?>" class="text-blue-600 hover:text-blue-800">
                                        ...
                                        <td>
                                            <a href="edit_telephone_directory.php?id=<?php echo $row['id']; ?>" class="py-1 px-2 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm">Edit</a>
                                            <form method="POST" action="" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this entry?');">
                                                ...
                                                <button type="submit" class="py-1 px-2 bg-red-600 text-white rounded hover:bg-red-700 text-sm">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
