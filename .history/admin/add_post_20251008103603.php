...
<body>
    <div class="main-container">
        ...
        <div class="content-wrapper">
            <!-- Sidebar Navigation -->
            <aside class="sidebar">
                <h2 class="sidebar-title">Post Management</h2>
                <nav class="sidebar-nav">
                    <a href="list_posts.php" class="sidebar-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>
                        </svg>
                        List Posts
                    </a>
                    <a href="post_views.php" class="sidebar-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        $(document).ready(function() {
            ...
            $("#postForm").validate({
                ...
                submitHandler: function(form) {
                    ...
                    // Check if content is empty (only contains <p><br></p> which is Quill's default empty state)
