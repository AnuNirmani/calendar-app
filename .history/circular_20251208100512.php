...
// Construct the query
$phone_sql = "SELECT DISTINCT td.id, td.name, td.phone_number, td.email, td.extension, d.name AS department_name, d.id AS department_id
...
<body>
                            ...
                            <div class="department-group">
                                <div class="department-header">
                                    ...
                                    <div class="department-count">
                                        <?php echo count($contacts); ?> contact(s)
                                    </div>
                                </div>
                                ...
                                <div class="department-contacts">
                                    ...
                                    <div class="contact-card">
                                        <div class="contact-info-row">
                                            ...
                                            <span class="badge bg-primary">Ext: <?php echo htmlspecialchars($entry['extension']); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="contact-detail">
                                                    ...
                                                    <span>ID: <?php echo htmlspecialchars($entry['id']); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">
                                ...
                                <?php elseif ($phone_dept !== 'all'): ?>
                                    No contacts found in the selected department
                                <?php else: ?>
                                    Start by searching for a contact or selecting a department
                                <?php endif; ?>
                            </p>
                            <?php if (!empty($phone_search) || $phone_dept !== 'all'): ?>
                            <a href="circular.php?tab=directory" class="btn btn-primary mt-3">
    ...
    <script>
        ...
        function quickSearch(value) {
            const url = new URL(window.location);
            url.searchParams.set('phone_search', value);
