                        ...
                        <div class="quick-stats">
                            ...
                            <div class="stat-item">
                                ...
                                <div class="stat-content">
                                    ...
                                    <strong><?php echo $phone_total_records; ?>+</strong>
                                </div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-icon">
    ...
    <main class="main-container">
        <div class="content-wrapper">
            <div class="tab-header">
                <h2 class="tab-title">Internal Communications Portal</h2>
                <p class="tab-description">Stay updated with latest circulars and connect with colleagues</p>
                
                <div class="tab-navigation">
                    <button class="tab-btn <?php echo $current_tab == 'circulars' ? 'active' : ''; ?>" 
                            data-tab="circulars">
                        <i class="fas fa-newspaper"></i>
                        Circulars
                    </button>
                    <button class="tab-btn <?php echo $current_tab == 'directory' ? 'active' : ''; ?>" 
                            data-tab="directory">
                        <i class="fas fa-address-book"></i>
                        Telephone Directory
                    </button>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-grid">
                    ...
                    <div class="footer-section">
                        <h4 class="footer-heading">Newsletters</h4>
                        <p class="footer-description">
                            Subscribe to get updates on latest circulars and announcements.
                        </p>
