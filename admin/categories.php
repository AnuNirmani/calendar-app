...
function createCategory($categoryName, $slug) {
    global $conn;
    ...
    $sql = "INSERT INTO categories (name, slug, status) VALUES (?, ?, 'published')";
...
function deleteCategory($categoryId) {
    ...
    // Check if the posts table exists first, if not, allow deletion
